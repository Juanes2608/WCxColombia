...
export const BACKGROUNDS: BgVariant[] = [
  {
    ...
    desc: "A drifting graph of connected nodes — citations/cases as a living network. Very on-theme.",
    Component: CitationNetwork,
  },
  {
    id: "spotlight",
    name: "Spotlight",
    desc: "A lime spotlight follows your cursor and lights up the dots in its path. Interactive — move the mouse.",
    Component: Spotlight,
  },
  {
    id: "flow",
    name: "Flow Lines",
    desc: "Lines that flow and ripple gently. Organic and elegant, no technical theme.",
    Component: FlowLines,
  },
  {
    id: "hud",
    name: "Forensic HUD",
    desc: "Concentric arcs that rotate, like a forensic monitoring instrument.",
    Component: Hud,
  },
  {
    id: "grid-scan",
    name: "Grid Scan",
    desc: "A lime band sweeps the forensic grid top to bottom, periodic. (current)",
    Component: GridScan,
  },
  {
    id: "radar",
    name: "Radar",
    desc: "A cone of light rotates continuously over the grid, like a monitor on watch.",
    Component: Radar,
  },
  {
    id: "sonar",
    name: "Sonar Pulse",
    desc: "Concentric rings expanding from the center, like a sonar pulse.",
    Component: Sonar,
  },
  {
    id: "aurora",
    name: "Aurora Drift",
    desc: "Soft color fields that drift more noticeably. Pure atmosphere, no technical theme.",
    Component: Aurora,
  },
  {
    id: "dots",
    name: "Dot Field",
    desc: "A dot matrix lit by drifting light, with a few dots flickering. A living corpus.",
    Component: DotField,
  },
  {
    id: "perspective",
    name: "Perspective Grid",
    desc: "A perspective grid advancing toward you (synthwave style), subtle and in lime.",
