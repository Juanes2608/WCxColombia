// Self-contained demo: a realistic 11-citation skeleton argument with verified,
// misapplied and fabricated authorities. Powers the "Demo" button so the full
// results experience (formatted document + verdict panel) works with no backend.
import type { AuthenticityVerdict, DocumentView, VerifyResult } from "./types";

export const DEMO: VerifyResult = {
...
export function buildDemoDocument(): DocumentView {
  const text =
